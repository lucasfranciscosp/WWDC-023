...
struct Screen22: View {
    ...
    @State private var count = 16 + 8 + 4 + 1
...
//            createBit(images: images, x1: 154 + 370/2, y1: 369 + 266/2, pow: 4, start: 3, w: 1.5, h: 1.5, count: count, isUP: true)
            ...
            if(count == 8 && currentImageIndex == 0 && currentImageIndex1 == 3 && currentImageIndex2 == 0 && currentImageIndex3 == 0 && currentImageIndex4 == 0){
                Image("botaonext")
            ...
            NavigationLink(destination: Screen23(), isActive: $shouldNavigate){
