...
struct Screen24: View {
    ...
    @State private var currentImageIndex3 = 3
    @State private var currentImageIndex4 = 3
    @State private var count = 16 + 8 + 2 + 1
    @State private var isUP = true
    @State private var isUP1 = true
    @State private var isUP2 = false
    @State private var isUP3 = true
    @State private var isUP4 = true
...
//            createBit(images: images, x1: 154 + 370/2, y1: 369 + 266/2, pow: 4, start: 3, w: 1.5, h: 1.5, count: count, isUP: true)
            ...
            if(count == 12 && currentImageIndex == 0 && currentImageIndex1 == 3 && currentImageIndex2 == 3 && currentImageIndex3 == 0 && currentImageIndex4 == 0){
                Image("botaonext")
            ...
            NavigationLink(destination: Screen25(), isActive: $shouldNavigate){
